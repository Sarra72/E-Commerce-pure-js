...
function drawProudectCart(products) {
  ...
  let y = products.map((item) => {
    ...
    return `
        <div id="product-${item.id}" class="product-item col-sm-6 col-12 mb-4">
        <div class="card border border-info">
          <div class="row">
            <div class="col-md-4">
              <img class="product-item-img card-img-top ml-3 mt-4 p-4" src="${item.imageURL}" alt="Card image">
            </div>
            <div class="col-md-8">
              ...
              <span class="text-danger mins p-0 m-0" style="font-size : 30px;  cursor: pointer; " onClick="mins(${item.id},${item.salePrice})">-</span>
                ...
                <div class="text-primary" style="font-size : 25px" id="quantity-${item.id}">${quantity}</div></div>
            </div>
          </div>
        </div>
      </div>
...
// ---------------------------------------------------------------------------------------------
let badge = document.querySelector(".badge-cart-page");
...
function drawFavData() {
  ...
  if (carouselIndicators && indicators) {
